...
from confident_learning import OnlineConfidentLearning
...
class MyModel(CruiseModule):
    ...
    def setup(self, stage) -> None:
        ...
        self.criterion_1 = OnlineConfidentLearning(
            alpha=0.5,
            n_classes=self.config_optim.class_num_lv1,
            smoothing=self.config_optim.label_smooth_1,
        )
        self.criterion_2 = OnlineConfidentLearning(
            alpha=0.5,
            n_classes=self.config_optim.class_num_lv2,
            smoothing=self.config_optim.label_smooth_2,
        )
    ...
    def on_train_epoch_end(self):
        self.criterion_1.reset()
        self.criterion_2.reset()
