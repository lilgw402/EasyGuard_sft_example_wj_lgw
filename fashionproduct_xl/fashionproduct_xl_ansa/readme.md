...
python3 examples/fashoinproduct_xl/fashionproduct_xl_ansa/run_train.py --print_config > examples/fashionproduct_xl/fashionproduct_xl_ansa/default_config.yaml
# 2. modify the file (remove useless non-config text at the beginning of the document)
vim exampless/fashoinproduct_xl/fashionproduct_xl_ansa/default_config.yaml
# 3. load the modified config back
python3 examples/fashoinproduct_xl/fashionproduct_xl_ansa/run_train.py --config examples/fashionproduct_xl/fashionproduct_xl_ansa/default_config.yaml
or
python3 examples/fashoinproduct_xl/fashionproduct_xl_ansa/run_train.py --config hdfs://path/to/your/default_config.yaml 
# 4. customize extra configs manually
python3 examples/fashoinproduct_xl/fashionproduct_xl_ansa/run_train.py --config examples/fashionproduct_xl/fashionproduct_xl_ansa/default_config.yaml --model.hidden_size=1024
```
