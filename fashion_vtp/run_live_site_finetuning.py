...
from easyguard.appzoo.fashion_vtp.live_site_data_new import LiveSiteDataModule
...
class MyModel(CruiseModule):
    ...
    def setup(self, stage) -> None:
        ...
        self.criterion_2 = nn.CrossEntropyLoss(ignore_index=-1, label_smoothing=self.config_optim.label_smooth_2)
